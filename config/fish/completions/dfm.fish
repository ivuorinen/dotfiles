...
set -l spec_file "$tmpdir/usage__usage_spec_dfm.spec"
echo $_usage_spec_dfm >"$spec_file"

set -l tokens
if commandline -x >/dev/null 2>&1
    complete -xc dfm -a "(command usage complete-word --shell fish -f \"$spec_file\" -- (commandline -xpc) (commandline -t))"
else
    complete -xc dfm -a "(command usage complete-word --shell fish -f \"$spec_file\" -- (commandline -opc) (commandline -t))"
end
