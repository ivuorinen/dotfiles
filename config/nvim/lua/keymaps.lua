...
-- Telescope
nld('cx', ':Telescope import', 'Telescope: Import')
nld('f', ':Telescope find_files<cr>', 'Find Files')
nld('<space>', ':Telescope buffers<cr>', 'Find existing buffers')
nld('sc', ':Telescope commands<cr>', 'Commands')
nld('sd', ':Telescope diagnostics<cr>', 'Search Diagnostics')
nld('sf', ':Telescope find_files<cr>', 'Find Files')
...
n('J', ":m '>+1<CR>gv=gv", { desc = 'Move Block Down' })
n('K', ":m '<-2<CR>gv=gv", { desc = 'Move Block Up' })
v('>', '>gv', { desc = 'Indent Right' })
v('<', '<gv', { desc = 'Indent Left' })
v('J', ":m '>+1<CR>gv=gv", { desc = 'Move Block Down' })
