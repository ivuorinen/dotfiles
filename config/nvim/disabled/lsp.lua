...
-- Default on_attach function for LSP servers
-- It creates a `:Format` command that formats the current buffer
-- with the LSP server if the server supports it.
-- This function is called for each LSP server that doesn't have a dedicated handler.
-- @param _ The client object
